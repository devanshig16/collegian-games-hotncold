...
const DisclaimerFooter = () => {
  const DEV_1 = { name: "Developer 1", url: "https://psucollegian.com" };
  const DEV_2 = { name: "Developer 2", url: "https://psucollegian.com" };
    ...
    <footer className="mt-16 w-full border-t border-slate-200 py-8 text-center font-sans">
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="max-w-md px-4 text-[10px] leading-relaxed text-slate-400 uppercase tracking-wide">
          ...
          <p className="mt-2">
            Accessibility Note: This game relies on text-based interactions. For full
            coverage, please visit{" "}
            <a
              className="font-semibold text-blue-700 hover:underline"
              href="https://www.psucollegian.com/"
              target="_blank"
              rel="noreferrer"
            >
              psucollegian.com
